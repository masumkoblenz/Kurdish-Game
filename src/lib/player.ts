...
export const achievements: Achievement[] = [
  ...
  { id: 'combo-5', icon: '🔥', title: 'Combo 5', description: 'Bigihîje Combo x5.', reward: 20, isUnlocked: (player, game) => Math.max(player.bestCombo, game?.bestCombo ?? 0) >= 5 },
  ...
  { id: 'quiz-master', icon: '🏆', title: 'Mamosteyê Quizê', description: '10 lîstikan biqedîne.', reward: 50, isUnlocked: (player) => player.gamesPlayed >= 10 },
  { id: 'coin-collector', icon: '🪙', title: 'Berhevkarê Coinan', description: '500 Coin berhev bike.', reward: 40, isUnlocked: (player) => player.coins >= 500 },
